...
const PartnerForm = ({ isMobile }) => {
  ...
  return (
    !isMobile ? <Box width='624px' borderRadius='16px' sx={{ background: '#1C1B34'}} padding='40px'>
    ...
    :
    <Box width='100%' borderRadius='8px 8px 0px 0px' sx={{ background: '#1C1B34'}} padding='20px 18px'>
      <Typography color='white' variant='h5' fontWeight='700' mb={3}>
        Request a 10 minute demo to see just how easily we can add value to your practice!
      </Typography>
      <Typography fontSize='14px' mb={1} color='white'>
        I am a...
